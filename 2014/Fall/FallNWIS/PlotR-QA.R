theme_USGS <-  function(base_size = 12){theme(
  ...
  axis.title.x = element_text (vjust = -2, size = 14,family="Times"), # change the axis title
  axis.title.y = element_text (vjust = -0.1, angle = 90, size = 14,family="Times"), # change the axis title
  axis.text.x = element_text (size = 12, vjust = -0.25, colour = "black",family="Times"),# change the axis label font attributes
  axis.text.y = element_text (size = 12, hjust = 1, colour = "black",family="Times"), # change the axis label font attributes
